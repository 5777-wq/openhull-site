...
(function () {
  ...
  var I18N = {
    zh: {
      ...
      "stats.l4": "个测试，都是绿的",
      "fig.detail": "艏部细节 · BOW DETAIL",
      "footer.aboutKey": "关于",
      "footer.linksKey": "链接",
      "footer.stateKey": "状态",
      "footer.goal": "目标只有一个：把船舶初步设计里能写成公式的东西，交给代码。",
      "how.kicker": "— 怎么用",
    ...
    en: {
      ...
      "fig.detail": "BOW DETAIL",
      "footer.aboutKey": "About",
      "footer.linksKey": "Links",
      "footer.stateKey": "Status",
      "footer.goal": "One goal: hand everything in preliminary design that can be written as an equation over to code.",
